...
By scheduling a lesson with me (Beth), you (the student/learner) agree as follows:
...
* You may be on camera at your discretion. I may be on camera at my discretion. *Occasional video work can be helpful.*
* You will be dressed as if for an in-person lesson, even if you do not plan to be on camera. *(Plans may change.)*
...
* If I am unable to make the scheduled time, I will endeavor to give you 24 hours notice. If I fail:
    * Less than 5 minutes late, we'll run overtime.
    * Between 5 and 15 minutes: We can either run overtime, reschedule, or add time to a future lesson by agreement.
    * More than 15 minutes: You may assume force majeure has happened to me. You will not owe for the missed lesson. We'll figure out a sensible solution as soon as feasible, with my apologies.


## Wellness:

* If either of us is physically or mentally unfit for a lesson (e.g. sick, vocal fatigue, panicked, etc.) then we can reschedule the unused time.
* Rescheduling **should not** become a pattern. If such a pattern seems evident, I **may** ask a fee to reschedule.
