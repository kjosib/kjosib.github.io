...
If you are using testosterone (for example, as a trans man) then you can 
then during the transformation 
you can expect some variation over time in your vocal abilities 

#### Hydration Break!

If you've read this far, go drink some water! Also, the password is "hydration". You'll need to know that for later.
...
**Things to minimize in the hours before training:**
